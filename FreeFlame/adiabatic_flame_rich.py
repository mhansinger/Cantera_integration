...
out_filename = 'FreeFlame_rich_states.h5'
...
Tin = 400  # inlet temperature unburnt gas [K]
yF1 = 1  # fuel
yO2 = 0.232  # oxidizer

# Parameters#
width = 0.005  # m
nf = 700  # number of flames to be computed
nu_st = 4  # stoichiometric
LFL = 0.055  # lower flammability limit CH4 mass fraction
UFL = 0.15  # upper flammability limit CH4 mass fraction
...
for yF in yFuel: #[0.055,0.06]:
    ...
    f.set_refine_criteria(ratio=3, slope=0.7, curve=0.7)
    f.show_solution()
    ...
    hdf_database.append('FreeFlame_rich_data', this_df)
    hdf_database.close()
